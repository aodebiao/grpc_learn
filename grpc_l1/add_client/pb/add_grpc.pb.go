...
func (UnimplementedAddServerServer) Add(context.Context, *AddRequest) (*AddResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedAddServerServer) mustEmbedUnimplementedAddServerServer() {}

// UnsafeAddServerServer may be embedded to opt out of forward compatibility for this service.
...
func _AddServer_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServerServer).Add(ctx, in)
	}
...
var AddServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Add",
			Handler:    _AddServer_Add_Handler,
		},
	},
